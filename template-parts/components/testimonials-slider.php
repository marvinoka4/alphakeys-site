...
<section class="testimonial-slider-section fluid grid-container">
    <div class="grid-container">
        <div class="grid-x grid-margin-x">
            <div class="cell">
                <div class="ins-testimonial-header">
                    <h2>Client <span>Reviews</span></h2>
                    <p>Read what our clients have said about us.</p>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        ?>
                                <div class="swiper-slide testimonial-slide">
                                    <div class="callout">
                                        <div class="star-rating" role="img" aria-label="<?php echo esc_attr($rating); ?> out of 5 stars">
                                            <?php for ($i = 1; $i <= 5; $i++) : ?>
                    ...
                    <div class="swiper-controls">
                        ...
                        <div class="swiper-navigation">
                            <div class="swiper-button-prev">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/util/vector-9.svg" alt="Previous">
                            </div>
                            <div class="swiper-button-next">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/util/vector-10.svg" alt="Next">
                            </div>
                        </div>
                    </div>
                </div>
