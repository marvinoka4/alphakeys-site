...
/**
 * 404 Content for Helium-Fdn Theme
 *
 * @package helium-fdn
 */
?>
...
<section class="error-page" aria-labelledby="error-title">
    <div class="grid-container">
        <div class="grid-x align-middle padding-vertical-2">
            <div class="cell medium-6 text-center">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" role="img" aria-label="<?php esc_attr_e('Spaceman Illustration for 404 Error', 'helium-fdn'); ?>" class="error-svg">
                    <g>
                        <defs>
                        ...
                        <g id="spaceman" clip-path="url(#cordClip)">
                            ...
                            <g id="armR">
                                <path fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                                        M360.633,363.039c1.352,1.061,4.91,5.056,5.824,6.634l27.874,47.634c3.855,6.649,1.59,15.164-5.059,19.02
                            ...
                            <g id="armL">
                                <path fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                                        M301.301,347.66c-1.702,0.242-5.91,1.627-7.492,2.536l-47.965,27.301c-6.664,3.829-8.963,12.335-5.134,18.999
                            ...
                            <g id="body">
                                <path fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                                        ...
                                        c-17.004,4.207-31.269,17.289-36.128,35.411l-1.374,5.123c-7.112,26.525,8.617,53.791,35.13,60.899
                                ...
                                <path fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                                        M269.678,394.912c26.3,20.643,59.654,29.585,93.106,25.724l2.419-0.114" />
                            </g>
                            <g id="legs">
                                <g id="legR">
                                    <path fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                                            M312.957,456.734l-14.315,53.395c-1.896,7.07,2.299,14.338,9.37,16.234c7.07,1.896,14.338-2.299,16.234-9.37l17.838-66.534
                                ...
                                <g id="legL">
                                    <path fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                                            M296.315,452.273L282,505.667c-1.896,7.07-9.164,11.265-16.234,9.37c-7.07-1.896-11.265-9.164-9.37-16.234l17.838-66.534
            ...
            <div class="cell medium-6 align-middle">
                <h1 id="error-title"><?php esc_html_e('404', 'helium-fdn'); ?></h1>
                <h2><?php esc_html_e('Oops! Page Not Found.', 'helium-fdn'); ?></h2>
                <p><?php esc_html_e('The page you’re looking for doesn’t exist. Click below to return to the homepage.', 'helium-fdn'); ?></p>
                <p><a class="button primary click-track" id="404-button" href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Back to Home', 'helium-fdn'); ?></a></p>
            </div>
        </div>
    </div>
</section>